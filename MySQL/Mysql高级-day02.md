...
![171214401286615](picture/000001.jpg) 
...
最上层是一些客户端和连接服务，包含本地sock 通信和大多数基于客户端/服务端工具实现的类似于 TCP/IP的通信。主要完成一些类似于连接处理、授权认证、及相关的安全方案。在该层上引入了线程池的概念，为通过认证安全接入的客户端提供线程。同样在该层上可以实现基于SSL的安全链接。服务器也会为安全接入的每个客户端验证它所具有的操作权限。
...
![1551186043529](picture/1551186043529.png) 
...
![1556086372754](picture/1556086372754.png)  	 
...
下面我们将重点介绍经常使用的两种存储引擎： InnoDB、MyISAM ， 另外两种 MEMORY、MERGE ， 了解即可。
...
![1556075130115](picture/1556075130115.png) 
...
![1556087540767](picture/1556087540767.png) 
...
![1556087611295](picture/1556087611295.png) 	
...
![1556087719145](picture/1556087719145.png) 
...
![1556087759615](picture/1556087759615.png)  

更新后， 子表的数据信息为 ： 

![1556087793738](picture/1556087793738.png)  
...
![1556075336630](picture/1556075336630.png) 
...
![1551347590309](picture/1551347590309.png) 
...
![1556075073836](picture/1556075073836.png) 
...
![1556076359503](picture/1556076359503.png) 
...
![1551408083254](picture/1551408083254.png) 

order_1991中的数据： 

![1551408133323](picture/1551408133323.png)  

order_all中的数据：

![1551408216185](picture/1551408216185.png) 
...
![1551408519889](picture/1551408519889.png) 	 	
...
![1552487172501](picture/1552487172501.png)  

```mysql
show status like 'Innodb_rows_%';
```

![1552487245859](picture/1552487245859.png)
